...
export const Home = () => {
  ...
  const handleAddFields = () => {
    ...
    values.push({  cuenta: "Gastos personales 0102***3245",
       banco: "none" ,
       tipodoc:"",
       numdoc:"",
       telefono:"",
...
console.log(event.target.checked);
  ...
  const resetForm = (e) => setInputFields([{  cuenta: "Gastos personales 0102***3245",
  banco: "none" ,
  tipodoc:"",
  numdoc:"",
  telefono:"",
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        <>
          ...
          >
            ...
            <Grid item xs={6}>
              <div className="divInputs">
                <select name="banco"    id="banco" className="selectText"   value={inputField.banco}
                                             onChange={(event) => handleInputChange(index, event)}>
                <option  value="none"  disabled selected>Pago frecuente</option>
            ...
            <Grid item xs={6}>
              <div className="divCheckbox">
                <input  name="checkbox"    id="checkbox"    type="checkbox"   onChange={(event) => handleInputChange(index, event)}/>{" "}
...
{
        inputField.checkbox  &&  <><Grid item xs={6}>
              <div style={{width: '86px', float:'left'}}>
                <select   defaultValue={"none"}  className="selectTextBeneficiario" name="tipodoc"    id="tipodoc"  value={inputField.tipodoc}
                                             onChange={(event) => handleInputChange(index, event)}>
            ...
            <Grid item xs={6}>
              <div className="divInputs">
                <select name="concepto" id="concepto" className="selectText" value={inputField.concepto}
                                             onChange={(event) => handleInputChange(index, event)}>
                <option  value="none"  disabled selected>Concepto(*)</option>
                  <option value="volvo">Volvo</option>
                  <option value="saab">Saab</option>
                  <option value="mercedes">Mercedes</option>
                  <option value="audi">Audi</option>
